...
private:
  ...
  bool IntersectLine(const vec3 &origin, const vec3 &dir, float &t1,
                     float t2) const;
  bool IntersectLineSegment(const vec3 &origin, const vec3 &dir, float tMin,
                            float tMax, float &t) const;
...
public:
   ...
   *
   */
  bool Intersect(const vec3 &origin, const vec3 &dir, float tMin,
                 float tMax) const;
...
public:
   ...
   *
   */
  bool Intersect(const vec3 &origin, const vec3 &dir, float tMin = 0.0f,
                 float tMax = std::numeric_limits<float>::max()) const;
