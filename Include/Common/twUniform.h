...
template<class T>
struct __TWCOMExport SimpleUniform<T, 1> : public Uniform
{
    T u0;
...
template<class T>
struct __TWCOMExport SimpleUniform<T, 2> : public Uniform
{
    T u0, u1;
...
template<class T>
struct __TWCOMExport SimpleUniform<T, 3> : public Uniform
{
    T u0, u1, u2;
...
template<class T>
struct __TWCOMExport SimpleUniform<T, 4> : public Uniform
{
    T u0, u1, u2, u3;
...
template<class T, uint32 N>
struct __TWCOMExport VecUniform : public Uniform
{
