...
// have compiler error due to "implementation found in double" so uncomment
// these line for prevent the creation of implementation of these libs again in
// ImGuiFileDialog #define DONT_DEFINE_AGAIN__STB_IMAGE_IMPLEMENTATION #define
...
// tableHeaderFileThumbnailsString " Thumbnails"
#define DisplayMode_FilesList_ButtonString ICON_IGFD_REORDER
//#define DisplayMode_FilesList_ButtonHelp "File List"
#define DisplayMode_ThumbailsList_ButtonString ICON_IGFD_FILE_LIST
//#define DisplayMode_ThumbailsList_ButtonHelp "Thumbnails List"
#define DisplayMode_ThumbailsGrid_ButtonString ICON_IGFD_SMALL_THUMBAILS
//#define DisplayMode_ThumbailsGrid_ButtonHelp "Thumbnails Grid"
// sleep time in millisedonce to apply in the thread loop, when no datas to
// extract the sleep time can be ssen jsut after the opening of a directory who
// contain pictures
...
#define editPathButtonString ICON_IGFD_PENCIL
