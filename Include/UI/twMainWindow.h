...
public:
    ...
    virtual void KeyCallBack(int32 key, int32 scannode, int32 action, int32 mods) {}
...
protected:
    ...
    virtual void KeyPress(int32 key
        ...
        , int32 action
        , int32 mods) = 0;
    virtual void KeyRelease(int32 key
        , int32 scannode
        , int32 action
        , int32 mods) = 0;
...
class __TWUIExport GLFWMainWindow : public MainWindow
{
public:
    ...
    virtual void WindowSizeCallback(int32 w, int32 h) override
    {
        ...
        {
            if (oldWidth == 0 || _width == 0 ||
                oldHeight == 0 || _height == 0)
                return;
    ...
    virtual void KeyCallBack(int32 key
        , int32 scannode
        , int32 action
        , int32 mods) override 
    {
