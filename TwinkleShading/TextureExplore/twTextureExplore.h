...
public:
  TextureExploreView()
      : View(), _vaos(nullptr), _vbos(nullptr), _ebos(nullptr),
        _sprite(nullptr), _wrapModes(), _wrapOption(-1), _filterModes(),
        _filterOption(-1), _swizzleOption(-1), _currentTexOption(-1),
        _lodbiasValue(1.0f), _updateTime(0.0f), _swizzleMasks(),
        _texparamsTabitem(), _enableLodBias(false), _enableBorderColor(false),
        _enableSkybox(false) {
