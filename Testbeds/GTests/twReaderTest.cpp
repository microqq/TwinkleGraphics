...
ShaderOption lineVertOption_(ShaderOption::OptionData{
    "Assets/Shaders/line.vert", ShaderType::VERTEX_SHADER});
ShaderOption lineFragOption_(ShaderOption::OptionData{
    "Assets/Shaders/line.frag", ShaderType::FRAGMENT_SHADER});
...
TEST(ResourceReaderTests, ReadAsync) {
  ...
  textureMgr.ReadTextureAsync("Assets/Textures/skybox/front.png",
                              &textureOption);
  textureMgr.ReadTextureAsync("Assets/Textures/skybox/front.png",
                              &textureOption);
